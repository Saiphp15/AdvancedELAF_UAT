        ...
        <div class="row">
            <div class="col-md-6">
                <div class="section-title">
                    <h2>Cart total <i class="icofont-star-alt-1"></i></h2>
                </div>
            ...
            <div class="col-md-6">
                <div class="promo-wrapper">
                    <div class="section-title mb-4">
                        <h2>Promo code <i class="icofont-star-alt-1"></i></h2>
                    </div>
                    <div class="promo-input">
                        <input class="form-control" type="text" placeholder="Enter Promo Code">
                        <button class="btn btn-primary brand-btn float-right">Apply</button>
                    </div>
                </div>
            </div>
        </div>
