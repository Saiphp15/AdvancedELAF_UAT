...
<section class="ot-banner-bg">
    <div class="container">
        <div class="section-title text-center">
            <h2><i class="icofont-star-alt-1"></i> Contact Us <i class="icofont-star-alt-1"></i> </h2>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="section-title text-right">
                    <h2><i class="icofont-star-alt-1"></i> Send Message</h2>
                </div>
                ...
                <div class="contact-form-wrapper">
                    ...
                    <button class="btn btn-primary brand-btn float-left">Send Message</button>
                </div>
            </div>
