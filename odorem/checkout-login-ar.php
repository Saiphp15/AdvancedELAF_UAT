            ...
            <div class="col-lg-5">
                <div class="checkout-login-wrapper">
                    ...
                    <div class="checkout-login-title">
                        <h4><i class="icofont-star-alt-1"></i> Log in</h4>
                    </div>
            ...
            <div class="col-lg-5">
                <div class="checkout-login-wrapper">
                    ...
                    <div class="checkout-login-title mb-3">
                        <h4><i class="icofont-star-alt-1"></i> Guest Log in</h4>
                    </div>
                    ...
                    <button class="btn btn-primary brand-btn ml-auto d-block">Checkout as guest</button>
                </div>
            </div>
