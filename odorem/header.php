...
<head>
    ...
    <!-- Cosma Stylesheet -->
    <link rel="stylesheet" href="assets/css/odorem-styles.css" />
    ...
    <header>
        ...
        <div class="header-container">
            ...
            <nav class="nav-content">
                ...
                <li class="nav-content-item"><a class="nav-content-link" href="cart.php"><i class="icofont-opencart"></i></a></li>
                <li class="nav-content-item"><a class="nav-content-link" href="index-ar.php">ع</a></li>
                <!-- call to action -->
                </ul>
            </nav>
        </div>
