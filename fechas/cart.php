    ...
    <div class="container">
        ...
        <div class="cart-action-buttons">
            <div class="d-grid gap-2 d-md-block ms-auto">
                <button class="db-brand-btn" type="button">Update Cart</button>
                <button class="g-brand-btn" type="button">Empty Cart</button>
                <button class="db-brand-btn" type="button">Continue Shopping</button>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-8">
                ...
                <div class="checkout-btn mt-3">
                    <button class="db-brand-btn">Proceed to Checkout</button>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="promo-wrapper">
                    ...
                    <div class="promo-input text-right">
