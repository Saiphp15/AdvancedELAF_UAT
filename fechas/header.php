...
<head>
    ...
    <!-- Fechas Stylesheet -->
    <link rel="stylesheet" href="assets/css/fechas-styles.css" />
    ...
    <header>
        <div class="header-container">
            ...
            <nav class="nav-content">
                ...
                <li class="nav-content-item"><a class="nav-content-link" href="cart.php"><i class="icofont-basket"></i></a></li>
                <li class="nav-content-item"><a class="nav-content-link lang-switch-text" href="index-ar.php">AR</a></li>
                <!-- call to action -->
                </ul>
            </nav>
        </div>
        ...
        <div class="nav-container">
            <nav class="all-category-nav">
                <label class="open-menu-all" for="open-menu-all">
                    ...
                    <span class="all-navigator"><i class="icofont-navigation-menu"></i> <span>All Categories</span>
                    ...
                    <ul class="all-category-list">
                        ...
                        <li class="all-category-list-item"><a href="#" class="all-category-list-link">Cat 1 <i class="fas fa-angle-right"></i></a>
                            <div class="category-second-list">
                                <ul class="category-second-list-ul">
                                    <li class="category-second-item"><a href="#">Deglet Nour</a></li>
                                    <li class="category-second-item"><a href="#">Deglet Nour Pitted</a></li>
                        ...
                        <li class="all-category-list-item"><a href="#" class="all-category-list-link">Cat 2 <i class="fas fa-angle-right"></i></a>
                            <div class="category-second-list">
                                <ul class="category-second-list-ul">
                                    <li class="category-second-item"><a href="#">Deglet Nour</a></li>
                                    <li class="category-second-item"><a href="#">Deglet Nour Pitted</a></li>
                        ...
                        <li class="all-category-list-item"><a href="#" class="all-category-list-link">Cat 3 <i class="fas fa-angle-right"></i></a>
                            <div class="category-second-list">
                                <ul class="category-second-list-ul">
                                    <li class="category-second-item"><a href="#">Deglet Nour</a></li>
                                    <li class="category-second-item"><a href="#">Deglet Nour Pitted</a></li>
                        ...
                        <li class="all-category-list-item"><a href="#" class="all-category-list-link">Cat 4 <i class="fas fa-angle-right"></i></a>
                            <div class="category-second-list">
                                <ul class="category-second-list-ul">
                                    <li class="category-second-item"><a href="#">Deglet Nour</a></li>
                                    <li class="category-second-item"><a href="#">Deglet Nour Pitted</a></li>
                        ...
                        <li class="all-category-list-item"><a href="#" class="all-category-list-link">Cat 5 <i class="fas fa-angle-right"></i></a>
                            <div class="category-second-list">
                                <ul class="category-second-list-ul">
                                    <li class="category-second-item"><a href="#">Deglet Nour</a></li>
                                    <li class="category-second-item"><a href="#">Deglet Nour Pitted</a></li>
                        ...
                        <li class="all-category-list-item"><a href="#" class="all-category-list-link">Cat 6 <i class="fas fa-angle-right"></i></a>
                            <div class="category-second-list">
                                <ul class="category-second-list-ul">
                                    <li class="category-second-item"><a href="#">Deglet Nour</a></li>
                                    <li class="category-second-item"><a href="#">Deglet Nour Pitted</a></li>
                        ...
                        <li class="all-category-list-item"><a href="#" class="all-category-list-link">Cat 7 <i class="fas fa-angle-right"></i></a>
                            <div class="category-second-list">
                                <ul class="category-second-list-ul">
                                    <li class="category-second-item"><a href="#">Deglet Nour</a></li>
                                    <li class="category-second-item"><a href="#">Deglet Nour Pitted</a></li>
            ...
            <nav class="featured-category">
                <ul class="nav-row">
                    <li class="nav-row-list"><a href="index.php" class="nav-row-list-link">Home</a></li>
                    <li class="nav-row-list"><a href="products.php" class="nav-row-list-link">Products</a></li>
                    <li class="nav-row-list"><a href="gift-cards.php" class="nav-row-list-link">Gift Cards</a></li>
                    <li class="nav-row-list"><a href="help.php" class="nav-row-list-link">Help</a></li>
                </ul>
            </nav>
        </div>
    </header>
