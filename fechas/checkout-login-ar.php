        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="checkout-login-wrapper text-right">
                    ...
                    <input type="text" class="brand-input mb-2" placeholder="Username*">
                    <input type="password" class="brand-input mb-2" placeholder="Password*">
            ...
            <div class="col-lg-5">
                <div class="checkout-login-wrapper-trans text-right">
                    <div class="section-tagline">
