...
// PRODUCT REPORTS CHART JS STARTS
...
var chart = new ApexCharts(document.querySelector("#productReportChart"), prodReportChart);
chart.render();

// PRODUCT REPORTS CHART JS ENDS

// PRODUCT SKU REPORTS CHART JS STARTS

var prodSKUReportChart = {
	series: [{
		name: 'Units Sold',
		data: [79]
	}],
	...
	xaxis: {
		categories: ['Product Variant SKU 1'],
	},
	yaxis: {
		title: {
			text: 'Units Sold'
...
var chart = new ApexCharts(document.querySelector("#productSKUReportChart"), prodSKUReportChart);
chart.render();

// PRODUCT SKU REPORTS CHART JS ENDS

// SALES REPORT CHART JS STARTS
...
var salesReportChart = {
	...
	xaxis: {
		categories: ['10 August 2022', '10 September 2022', '10 October 2022', '10 November 2022', '10 December 2022'],
	},
	yaxis: {
		title: {
			text: 'Amount'
...
var chart = new ApexCharts(document.querySelector("#salesReportChart"), salesReportChart);
chart.render();

// SALES REPORT CHART JS ENDS

// MONTHLY SALES REPORT CHART JS STARTS

var monthlySalesReportChart = {
	series: [{
		name: 'Total Orders',
		data: [16, 35, 97, 56, 120]
	}],
	chart: {
		type: 'bar',
		height: 350,
...
var chart = new ApexCharts(document.querySelector("#monthlySalesReportChart"), monthlySalesReportChart);
chart.render();

// MONTHLY SALES REPORT CHART JS ENDS

// USER REPORT CHART JS STARTS
...
var chart = new ApexCharts(document.querySelector("#userReportChart"), userReportChart);
chart.render();

// USER REPORT CHART JS ENDS

// USER ACTIVITY REPORT CHART JS STARTS

var userActivityReportChart = {
	series: [{
		name: 'Amount',
		data: [97]
	}],
...
var chart = new ApexCharts(document.querySelector("#userActivityReportChart"), userActivityReportChart);
chart.render();

// USER ACTIVITY REPORT CHART JS ENDS