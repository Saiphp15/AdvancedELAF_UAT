...
<head>
    ...
    <!-- Playhub Stylesheet -->
    <link rel="stylesheet" href="assets/css/playhub-styles.css" />
                ...
                <div class="row align-items-center">
                    <div class="col-md-9">
                        <div class="d-flex search-btn">
                            <input type="search" class="brand-input" placeholder="What are you looking for?">
                            <button class="brand-btn-black ml-2"><i class="icofont-search"></i></button>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="dropdown text-right mt-sm-2 mt-md-0 mt-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto mb-2 mb-lg-0 mob-ar-align">
                    ...
                    <li class="nav-item dropdown header-item">
                        <a class="nav-link dropdown-toggle" href="products.php" role="button" data-bs-toggle="dropdown">
                            Products
                        </a>
