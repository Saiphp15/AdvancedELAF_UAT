...
<!-- POST FEEDBACK MODAL STARTS -->

<div class="modal brand-modal fade" id="postFeedbackModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered brand-modal-dialog">
        <div class="modal-content brand-modal-content">
            <div class="modal-header brand-modal-header">
                <h5 class="modal-title brand-modal-title">Post a Feedback</h5>
            ...
            <div class="modal-body brand-modal-body">
                <div class="mb-2">
                    <label class="brand-label text-orange">Rating<span class="required-mark">*</span></label>
                ...
                <div class="mb-2">
                    <label class="brand-label text-orange">Feedback<span class="required-mark">*</span></label>
                    <textarea class="brand-input" rows="3"></textarea>
                </div>

                <div class="text-right">
                    <button class="brand-btn-orange">Submit</button>
                    <button class="brand-btn-black" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-7">
                <div class="prod-main-detail">
                    ...
                    <div class="d-grid gap-2 d-md-block">
                        ...
                        <button class="brand-btn-add-wishlist">Wishlist</button>
                    </div>

                    <div class="feedback-links mt-4">
                        <a href="#" data-toggle="modal" data-target="#postFeedbackModal">
