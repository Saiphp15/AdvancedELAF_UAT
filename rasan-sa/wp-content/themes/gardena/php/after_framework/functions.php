...
if ( function_exists( 'bt_bb_add_params' ) ) {
	bt_bb_add_params( 'bt_bb_section', array(
		...
		array( 'param_name' => 'bottom_spacing', 'type' => 'dropdown', 'heading' => esc_html__( 'Bottom spacing', 'gardena' ), 'weight' => 2, 'preview' => true,
			'value' => array(
				esc_html__( 'No spacing', 'gardena' ) 	=> '',
				esc_html__( 'Extra small', 'gardena' ) 	=> 'extra_small',
				esc_html__( 'Small', 'gardena' ) 		=> 'small',		
...
if ( function_exists( 'bt_bb_add_params' ) ) {
	bt_bb_add_params( 'bt_bb_separator', array(
		...
		array( 'param_name' => 'bottom_spacing', 'type' => 'dropdown', 'heading' => esc_html__( 'Bottom spacing', 'gardena' ), 'weight' => 1, 'preview' => true,
			'value' => array(
				esc_html__( 'No spacing', 'gardena' ) 	=> '',
				esc_html__( 'Extra small', 'gardena' ) 	=> 'extra_small',
				esc_html__( 'Small', 'gardena' ) 		=> 'small',		
