	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Headline', 'gardena' ), 'description' => esc_html__( 'Headline with custom Google fonts', 'gardena' ), 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode, 'highlight' => true,
			'params' => array(
				...
				array( 'param_name' => 'size', 'type' => 'dropdown', 'heading' => esc_html__( 'Size', 'gardena' ), 'preview' => true, 'description' => 'Predefined heading sizes, independent of html tag',
					'value' => array(
				...
				array( 'param_name' => 'align', 'type' => 'dropdown', 'heading' => esc_html__( 'Alignment', 'gardena' ),
					'value' => array(
						esc_html__( 'Inherit', 'gardena' ) => 'inherit',
