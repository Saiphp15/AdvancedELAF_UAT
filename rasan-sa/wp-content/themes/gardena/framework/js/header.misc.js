...
(function( $ ) {
	...
	/*ARABIC LANGUAGE SWITCHER CODE*/
	
	(function () {
		var theLanguage = $('html').attr('lang');
		if (theLanguage == 'ar') {
			$(".btMenuHorizontal.btMenuRight .menuPort nav").css({"float": "left"});
			$(".bt_bb_card_icon_content, ul#menu-custom-menu").css({"text-align":"right"});
			$(".bt_bb_text, ul#menu-primary-menu, .bt_bb_headline_content, .bt_bb_button_text, .bt_bb_headline_subheadline, .bt_bb_card_icon_title, .bt_bb_card_icon_text, .bt_bb_headline_superheadline, .bt_bb_progress_bar_text, .bt_bb_size_small.bt_bb_icon .bt_bb_icon_holder > span, form.wpcf7-form.init, .bt_bb_custom_menu div ul a").css({"font-family":"Almarai, sans-serif"});
			$(".bt_bb_card_icon_content").css({"height":"300px"});
			$("form.wpcf7-form.init").css({"direction":"rtl"});
		}
