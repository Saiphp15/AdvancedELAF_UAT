    ...
    <div class="custom-container">
        <div class="domain-section-wrapper blue-bg">
            ...
            <div class="domain-plan-name">
                <h4>Plan Selected: <span class="pink-highlighter font-weight-bold">SAR 459</span></h4>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="chck-domain-btn">
                        <button class="btn btn-primary brand-btn-pink">Check Availability</button>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="chooseDomain">
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="radio" name="exampleRadios" id="domain-checkbox-two" value="option1" checked="">
                            <label class="form-check-label" for="domain-checkbox-two">I want to use existing domain</label>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text domain-group-text">http://www.</span>
            ...
            <div class="row">
            <button class="btn btn-primary brand-btn-purple mx-auto d-block">Proceed</button>
            </div>
        </div>
    </div>
</section>
