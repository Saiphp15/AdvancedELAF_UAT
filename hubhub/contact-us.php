        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="contact-form mb-3">
                    ...
                    <div class="mb-3">
                        <input type="text" class="brand-input" placeholder="Email Address"> 
                    </div>

                    <div class="mb-3">
                        <textarea rows="4" class="brand-textarea" placeholder="Your Message"></textarea>
                    </div>
