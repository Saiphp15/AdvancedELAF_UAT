...
<head>
    ...
    <!-- Cosma Stylesheet -->
    <link rel="stylesheet" href="assets/css/hubub-styles-ar.css" />
    ...
    <header>
        <div class="header-container">
            ...
            <nav class="nav-content">
                ...
                <li class="nav-content-item"><a class="nav-content-link" href="cart-ar.php"><i class="icofont-cart-alt"></i></a></li>
