            ...
            <div class="col-lg-8">
                <div class="prod-main-detail">
                    ...
                    <div class="d-grid gap-2 d-md-block text-right">
                        ...
                        <button class="btn btn-primary brand-btn-black-outline">Wishlist</button>
                    </div>

                    <div class="feedback-links mt-4">
                        <a href="post-feedback-ar.php"><h4><i class="icofont-ui-edit"></i> Post a feedback</h4></a>
                        <a href="view-feedback-ar.php"><h4><i class="icofont-eye-alt"></i> View all feebacks</h4></a>
                    </div>
                </div>
            </div>
        </div>
