                ...
                <ul class="nav-content-list">
                    <li class="nav-content-item account-login">
                        <label class="open-menu-login-account" for="open-menu-login-account">
                            ...
                            <!-- submenu -->
                            <ul class="login-list">
                                <li class="login-list-item"><a href="login.php">Login</a></li>
                                <li class="login-list-item"><a href="signup.php">Signup</a></li>
                                <li class="login-list-item"><a href="my-account.php">My Account</a></li>
                                <li class="login-list-item"><a href="#">Logout</a></li>
                        </label>
                </ul>
                </li>

                <li class="nav-content-item"><a class="nav-content-link" href="cart.php"><i class="icofont-cart"></i></a></li>
